...
function App() {
  ...
  return (
    <div style={{ display: 'inline' }}>
      <div id='side-panel' style={{ position: 'fixed', width: '23%', height: '100%', margin: '0px', backgroundImage: `url('../src/assets/him.jpg')`, minWidth: '300px', zIndex: '6', boxShadow: '1px 0px 8px 5px rgba(0, 0, 0, 0.2)' }}>
      ...
      <div id='main-content-div' style={{ position: 'fixed', right: '0px', backgroundColor: 'white', zIndex: '1' }}>
